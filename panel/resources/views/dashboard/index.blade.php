                ...
                <div class="space-y-4 px-2">
                    ...
                    <div class="flex items-center group">
                        ...
                        <div class="flex-1 flex items-center gap-3">
                            ...
                            <div>
                                <a href="{{ route('sites.show', $site->domain) }}" target="_blank" class="font-bold text-gray-900 dark:text-white text-sm group-hover:text-brand-500 transition-colors cursor-pointer">{{ $site->domain ?? 'domain.com' }}</a>
